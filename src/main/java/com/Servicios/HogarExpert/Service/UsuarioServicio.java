...
public class UsuarioServicio implements IUsuarioServicio {
    ...
    public Usuario update(Usuario usuario) throws MiException {
        Usuario usua = usuarioRepo.findById(usuario.getId()).orElse(null);
        Usuario u = usuario;
        if (usua.getImagen() != u.getImagen()) {
            u.setImagen(usua.getImagen());
        }

        usuarioRepo.save(u);
        System.out.println("servicio modificar");
